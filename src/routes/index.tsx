...
function Index() {
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-6 py-16">
        <section className="grid items-center gap-10 md:grid-cols-2">
          <div>
            ...
            <h1 className="mt-4 font-bold leading-[1.05] md:text-5xl">
              Faça parte da história que Deus está escrevendo.
            </h1>
      ...
      <footer className="border-t border-border py-8 text-center text-sm text-white bg-cover bg-center bg-no-repeat w-full" style={{ backgroundImage: "url('/src/images/BACKGROUND SITE (1).png')" }}>
